...
int main(void) {
  ...
  if (b.IndexarDirectorio("./directorio_que_no_existe"))
    ...
    cout << "NO SE HA INDEXADO EL DIRECTORIO ./directorio_que_no_existe"
         << endl;
  ...
  if (a.Devuelve("pal1", "./corpus_corto/fichero1.txt", infDoc1))
    cout << "pal1 SE HA INDEXADO EN ./corpus_corto/fichero1.txt: " << infDoc1
         << endl;
  else
  ...
  if (a.Devuelve("pal7", "./corpus_corto/fichero1.txt", infDoc1))
    cout << "pal7 SE HA INDEXADO EN ./corpus_corto/fichero1.txt: " << infDoc1
         << endl;
  else
